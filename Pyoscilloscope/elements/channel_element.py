    ...
    def __getitem__(self, key):
        ...
        try:
            scope_value = self.__instr.ask(command_format)
             ...
             print("Error: A failure has occurred writing", command_format, "to the scope at channel_element getter. Possible scope timeout. No data received")
             return  
        ...
        try:
            ...
            print("Error: Unexpected return string from scope:", scope_value, "at channel_element getter. Unable to parse and retrieve value. No data received")
            return
    ...
    def __setitem__(self, key, value):
        ...
        if value != None:
            ...
            try:
                ...
                print("Error: A failure has occurred writing", self.command, "to the scope at channel_element setter. Possible scope timeout")
...
class Wave_Preamble(Channel_Element):
    ...
    def __setitem__(self, key, value):
        print("Error: Trying to set preamble at channel", str(key), "with value", str(value), "Cannot set wave premable, can only receive wave premable")
...
class Display(Channel_Element):
    ...
    def __getitem__(self, key):
        ...
        try:
            ...
            print("Error: A failure has occurred writing", command_format, "to the scope at display_element getter. Possible scope timeout. No data received")    
        ...
        if str(scope_value).find("ON"):
            ...
            print("Error: Unexpected return value for display_element. The string does not inlclude OFF or ON")    
    ...
    def __setitem__(self, key, value):
        ...
        if type(value) == int:
            ...
            print("Error: Unexpected input:", value, "on channel,", str(key), "at display_element setter. Setting channel,", str(key), "to ON")
            self.channel[key] = "ON"        
...
class Wave_Data():
    ...
    def __getitem__(self, key):
        ...
        if self.one_line_command:
            command_format = self.channel_format + str(key) + self.command + self.command_query + " DAT2"
            self.__instr.write(command_format)
